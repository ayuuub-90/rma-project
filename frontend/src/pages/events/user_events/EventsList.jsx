...
import { useDeleteEventMutation, useGetUserEventsQuery } from "../../../redux/api/eventApiSlice";
...
const EventsList = () => {
  ...
  const { data: events, refetch } = useGetUserEventsQuery({ id: user._id });
  ...
  return (
    <div>
      <h2 className="text-2xl p-4 font-medium">mes events </h2>
